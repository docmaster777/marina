...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="/web/assets/js/plugin/html5shiv.js"></script>
    <script src="/web/assets/js/plugin/respond.js"></script>
    <![endif]-->
</head>
    ...
    <header class="main-header style-2">
        <div class="container-fluid rel-div">
            <div class="col-lg-4 col-sm-8">
                <div class="main-logo">
<!--                    <a href="index.html"> <img alt="" src="/web/assets/img/logo/logo-2.png" />  </a>-->
            ...
            <div class="col-lg-6 responsive-menu">
                ...
                <nav class="fix-navbar" id="primary-navigation">
                    <ul class="primary-navbar">
                        <li class="active"><a href="/biser">Бисер</a></li>
                        <li><a href="/businy">Бусины</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true">Фурнитура</a>
                            <ul class="dropdown-menu">
                                <li><a href=""> Колпачки </a></li>
                            </ul>
                        </li>
                        <li><a href="">Готовые украшения</a></li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="col-lg-2 col-sm-4 cart-megamenu">
                <div class="cart-hover">
                    <a href="#"> <img alt="" src="assets/img/icons/cart-icon-1.png" /> </a>
                    <span class="cnt crl-bg">0</span> <span class="price">$0</span>
                ...
                <div class="mega-submenu">
                            ...
                            <span class="nav-trigger">
                                <a class="menu-toggle" href="#"> <img src="assets/img/icons/menu-1.png" alt="" /> </a>
                            </span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-12 footer-widget">
                        <div class="main-logo">
<!--                            <a href="index.html"> <img alt="" src="/web/assets/img/logo/logo-1.png" />  </a>-->
                            <span class="medium-font">ORGANIC STORE</span>
                        </div>
...
<!--            <div class="main-logo">-->
<!--                <a href="index.html"> <img alt="" src="/web/assets/img/logo/main-logo.png" />  </a>-->
<!--            </div>-->
<!---->
